...
//
//	mockgen -source=internal/adapters/datasources/repositories/role/repository.go -destination=internal/adapters/datasources/repositories/role/mocks/repository.go
//
...
func (m *MockRepository) Create(arg0 context.Context, arg1 domain.Role) (string, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepository) Get(arg0 context.Context, arg1 role.GetFilterOptions) (*domain.Role, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepository) List(arg0 context.Context, arg1 role.ListFilterOptions) ([]domain.Role, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepository) Update(arg0 context.Context, arg1 string, arg2 *domain.Role) (string, error) {
	m.ctrl.T.Helper()
