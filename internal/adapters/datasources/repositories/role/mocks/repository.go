...
// Source: internal/adapters/datasources/repositories/role/repository.go
//
// Generated by this command:
//
//	mockgen -source=internal/adapters/datasources/repositories/role/repository.go -destination=internal/adapters/datasources/repositories/role/mocks/repository.go -package=mocks
//
...
import (
	...
	role "github.com/tapiaw38/auth-api-be/internal/adapters/datasources/repositories/role"
...
func (m *MockRepository) Create(arg0 context.Context, arg1 domain.Role) (string, errors.ApplicationError) {
	m.ctrl.T.Helper()
...
func (m *MockRepository) Delete(arg0 context.Context, arg1 string) errors.ApplicationError {
	m.ctrl.T.Helper()
...
func (m *MockRepository) Get(arg0 context.Context, arg1 role.GetFilterOptions) (*domain.Role, errors.ApplicationError) {
	m.ctrl.T.Helper()
...
func (m *MockRepository) List(arg0 context.Context, arg1 role.ListFilterOptions) ([]domain.Role, errors.ApplicationError) {
	m.ctrl.T.Helper()
...
func (m *MockRepository) Update(arg0 context.Context, arg1 string, arg2 *domain.Role) (string, errors.ApplicationError) {
	m.ctrl.T.Helper()
