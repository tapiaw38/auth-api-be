...
//
//	mockgen -source=internal/usecases/role/ensure.go -destination=internal/usecases/role/mocks/ensure.go -package=mocks
//
...
func (m *MockEnsureUseCase) Execute(arg0 context.Context) errors.ApplicationError {
	m.ctrl.T.Helper()
