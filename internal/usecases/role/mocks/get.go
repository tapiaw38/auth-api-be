...
//
//	mockgen -source=internal/usecases/role/get.go -destination=internal/usecases/role/mocks/get.go -package=mocks
//
...
func (m *MockGetUsecase) Execute(arg0 context.Context, arg1 role.GetFilterOptions) (*role.GetOutput, errors.ApplicationError) {
	m.ctrl.T.Helper()
