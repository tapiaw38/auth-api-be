...
//
//	mockgen -source=internal/usecases/role/list.go -destination=internal/usecases/role/mocks/list.go -package=mocks
//
...
func (m *MockListUsecase) Execute(arg0 context.Context, arg1 role.ListFilterOptions) ([]role.RoleOutputData, errors.ApplicationError) {
	m.ctrl.T.Helper()
