...
//
//	mockgen -source=internal/usecases/user/get.go -destination=internal/usecases/user/mocks/get.go
//
...
func (m *MockGetUsecase) Execute(arg0 context.Context, arg1 user.GetFilterOptions) (*user.GetOutput, error) {
	m.ctrl.T.Helper()
